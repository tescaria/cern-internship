...
def plot_glops_s(df_full, df_roi, theoretical_gflops, output_path=None, nthreads=1, nevent=10):
    ...
    axes[0].set_ylabel("Kernel", fontsize=16)
    axes[0].set_xlabel("Achieved FP32 Performance / Theoretical Peak [%]", fontsize=17)
    axes[1].set_xlabel("Achieved FP32 Performance / Theoretical Peak [%]", fontsize=17)
